...
IMAGE_UPLOAD_KINDS = {"course_cover", "question_media", "avatar", "logo", "student_post_image", "teacher_certificate", "blog_cover", "blog_image"}
UPLOAD_LIMITS = {
    "video": 200 * 1024 * 1024,
...
STAFF_UPLOAD_KINDS = VIDEO_UPLOAD_KINDS | HANDOUT_UPLOAD_KINDS | {"course_cover", "question_media", "avatar", "teacher_certificate", "blog_cover", "blog_image"}
