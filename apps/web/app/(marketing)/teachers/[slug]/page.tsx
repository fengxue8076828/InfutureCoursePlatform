    ...
    <main className="bg-mist">
      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <section className="mt-8 grid gap-6 lg:grid-cols-[1fr_24rem]">
          ...
          <div className="panel rounded-lg p-6">
            <p className="text-sm font-black uppercase tracking-wide text-coral">Focus</p>
            <h2 className="mt-2 text-2xl font-black text-ink">{labels.focus}</h2>
            ...
            <div className="mt-6 grid gap-3 text-sm font-semibold text-slate-600">
              <div className="flex items-center gap-3 rounded-lg bg-slate-50 p-3">
                <GraduationCap size={18} className="text-coral" /> {labels.clearGoals}
              </div>
              <div className="flex items-center gap-3 rounded-lg bg-slate-50 p-3">
                <Award size={18} className="text-coral" /> {labels.feedback}
              </div>
            </div>
          </div>
        </section>
